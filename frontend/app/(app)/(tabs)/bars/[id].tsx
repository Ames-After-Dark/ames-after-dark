...
import { 
  BarHeader, 
  BarStats, InfoSection, BottomCard, BarMapModal } from "@/components/bars/bar-detail-components";
...
export default function BarProfile() {
  ...
  if (loading) return (
    <View style={styles.center}><ActivityIndicator color={Theme.dark.primary} /></View>
  );
